...
const copy = {
  demo: {
    ...
    title: 'Explore a company brain for your robotics team.',
    lead: 'Tell us about your robots, knowledge sources, and the investigations or handoffs that consume the most team time.',
    submit: 'Request demo',
    ...
    messageLabel: 'What should your company brain help with?',
    messagePlaceholder: 'Fleet incidents, release readiness, field service, engineering handoffs…',
    requireMessage: false,
  },
  waitlist: {
    kicker: 'JOIN THE WAITLIST',
    title: 'Get early access for your robotics team.',
    lead: 'Join the waitlist for robotics companies building a shared memory across engineering, fleet operations, and the field.',
    ...
    messagePlaceholder: 'Robot type, fleet size, engineering stack, biggest knowledge bottleneck…',
    requireMessage: false,
  },
}
